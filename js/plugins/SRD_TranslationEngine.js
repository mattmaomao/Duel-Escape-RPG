...
$.loadMapNoteData = function() {
	...
	var updateFields = $.parseMAPNoteData(data);
	if(updateFields) {
		$.applyUpdateFields(data, updateFields);
	}
};

$.parseMAPNoteData = function(data) {
...
Window_Options.prototype.languageStatusText = function(value) {
	...
	return value === 0 ? String($.params['Source Language Name']) : $.languages[value - 1];
};
